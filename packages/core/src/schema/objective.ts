 ...
 * second one. See ObjectStore.assertImmutableFieldsUnchanged, which consumes this list
 * via IMMUTABLE_FIELDS_BY_SUBTYPE, and ImmutableObjectiveFieldError, which it throws.
 */
